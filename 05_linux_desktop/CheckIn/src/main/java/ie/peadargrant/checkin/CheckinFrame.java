 ...
 */
package ie.peadargrant.checkin;
...
public class CheckinFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jScrollPane1.setName("textArea"); // NOI18N

        responseBox.setBackground(new java.awt.Color(0, 0, 0));
        responseBox.setColumns(20);
        responseBox.setFont(new java.awt.Font("Segoe UI", 1, 24)); // NOI18N
        responseBox.setForeground(new java.awt.Color(255, 255, 51));
        responseBox.setRows(5);
        responseBox.setName("responseBox"); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        responseBox.setText("Check in button pressed!");
